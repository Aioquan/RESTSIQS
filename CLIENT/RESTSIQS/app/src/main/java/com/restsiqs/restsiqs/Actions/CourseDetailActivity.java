...
public class CourseDetailActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        courseCredit = (TextView) findViewById(R.id.courseCredit);
        courseTime = (TextView) findViewById(R.id.courseTime);
        courseDate = (TextView) findViewById(R.id.courseDate);
        test1 = (TextView) findViewById(R.id.test1);
        test2 = (TextView) findViewById(R.id.test2);
        test3 = (TextView) findViewById(R.id.test3);
        exercises1 = (TextView) findViewById(R.id.exercises1);
        exercises2 = (TextView) findViewById(R.id.exercises2);
        exercises3 = (TextView) findViewById(R.id.exercises3);
        exercises4 = (TextView) findViewById(R.id.exercises4);
        exercises5 = (TextView) findViewById(R.id.exercises5);
        finalTest = (TextView) findViewById(R.id.finalTest);
        dailyMark = (TextView) findViewById(R.id.dailyMark);
        //18
