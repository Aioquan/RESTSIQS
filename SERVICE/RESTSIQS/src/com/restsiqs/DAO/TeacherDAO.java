 ...
 * 
 * @see com.restsiqs.Entities.Teacher
...
public class TeacherDAO {
	...
	public Teacher findById(java.lang.String id) {
		...
		try {
			Teacher instance = (Teacher) getCurrentSession().get(
					"com.restsiqs.Entities.Teacher", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Teacher instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("com.restsiqs.Entities.Teacher")
	...
	public List findByTeacherDepartment(Object teacherDepartment) {
		return findByProperty(TEACHER_DEPARTMENT, teacherDepartment);
	}
